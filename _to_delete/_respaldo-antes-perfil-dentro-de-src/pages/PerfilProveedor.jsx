...
export default function PerfilProveedor() {
  ...
  // Lo define el proveedor en Ajustes > Entregas. En cero no se
  // muestra: mejor no prometer capacidad que no declaró.
  const capacidadDespacho = useStore((s) => s.configuraciones.proveedor?.capacidadDespacho || 0)
      ...
      <PerfilHero
        ...
        chips={[
          ...
          ...(capacidadDespacho > 0
            ? [
                {
                  label: `Hasta ${capacidadDespacho.toLocaleString('es')} unidades al mes`,
                  icono: 'package',
                },
              ]
            : []),
