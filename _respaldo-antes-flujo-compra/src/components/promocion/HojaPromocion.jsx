...
/* ══════════════════════════════════════════════════════════════
   La hoja que sube desde abajo cuando el cliente toca "Ver" en una
   promoción del Home.
...
export default function HojaPromocion({ promo, onClose }) {
      ...
      {abierta && (
        ...
        >
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-label={`Promoción: ${promo.titulo}`}
          ...
          >
            ...
            <div className="vc-hoja__contenido">
              <DetallePromocion promo={promo} variante="hoja" onVerTodo={verTodo} onCerrar={onClose} />
            </div>
          </motion.div>
        </motion.div>
      )}
