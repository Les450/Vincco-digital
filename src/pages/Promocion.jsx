...
import { buscarPublicacion } from '../utils/promociones'
...
export default function Promocion() {
  ...
  const promo = useMemo(() => buscarPublicacion(id, respaldo), [id, respaldo])
      ...
      <div className="vc-promo-pagina__caja">
        {promo ? (
          ...
          <div className="vc-promo-pagina__vacio">
            ...
            <h3>Esto ya no está</h3>
            <p>Puede que el negocio lo haya quitado o que se haya vencido.</p>
