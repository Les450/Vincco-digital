...
const GRUPO_APP = {
  ...
  ajustes: [
    ...
    },
    {
      ...
      icono: 'moon',
      label: 'Tema',
      ayuda: 'Automático sigue el modo claro u oscuro de tu teléfono',
      opciones: [
    ...
    },
    {
      ...
      opciones: [
        ...
        { valor: 'muyGrande', label: 'Muy grande' },
      ],
    },
    {
      id: 'altoContraste',
    ...
    {
      id: 'reducirAnimaciones',
      tipo: 'switch',
      icono: 'pause',
      label: 'Reducir animaciones',
      ayuda: 'Menos movimiento en pantalla: cansa menos la vista y ahorra batería',
    },
  ],
}
...
const CLIENTE = [
  ...
  },
  {
    ...
    },
    {
      ...
      tipo: 'switch',
      icono: 'eye-off',
      label: 'Ocultar mi saldo de puntos',
      ayuda: 'Se ve como puntos suspensivos hasta que toques el ojo. Nadie que te mire el celular sabe cuánto llevás',
    },
      {
        id: 'confirmarCanje',
        tipo: 'switch',
...
const NEGOCIO = [
  {
    ...
    ajustes: [
      ...
      },
      {
        ...
        ayuda: 'De vacaciones o arreglos: tu ficha muestra "Cerrado temporalmente" en vez de "Abierto ahora"',
      },
    ],
  },
  {
...
const PROVEEDOR = [
  ...
  },
  {
    ...
    ajustes: [
      ...
      {
        id: 'capacidadDespacho',
        tipo: 'numero',
        icono: 'package',
        label: 'Capacidad de despacho por mes',
        ayuda: 'Cuántas unidades podés entregar al mes: así el negocio sabe si te conviene para pedidos grandes',
        min: 0,
        max: 100000,
        paso: 50,
        sufijo: 'unidades',
